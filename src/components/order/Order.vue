  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column lable="订单编号" prop="order_number"></el-table-column>
        <el-table-column lable="是否付款">
        ...
        <el-table-column lable="是否发货" prop="is_send"></el-table-column>
        <el-table-column lable="下单时间" prop="create_time">
          <template slot-scope="scope">
